  ...
  response = client.chat.completions.create(
      ...
      messages = [
          {'role': 'system',
           ...
           Given a topic, you can write quality fantasy stories with an opened ending.
           The story must be around 100-150 words long only.
           """},
          {'role': 'user',
           'content': prompt}
      ],
...
def cover_art(prompt):
    response = client.images.generate(  # generate, edit, create_variations
        model='dall-e-3',
        prompt=prompt,
        size='1024x1024',
        quality='standard',
  ...
  response = client.chat.completions.create(
      ...
      messages = [
          {'role': 'system',
           ...
           A story will be given and you have to analyze and digest the contents, and extract the main elements or essence of the story.
